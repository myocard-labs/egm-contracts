...
Schema version: `1.0` (plain X.Y string, matching all other schemas in
this package).
...
- `threshold_mode` ("absolute" | "percentile"), `threshold_value`
...
- Applying the threshold strategy to select segments.
